...
class APIRouterService {
     ...
     */
    async routeRequest(method, path, headers, body, context) {
     ...
     */
    handleRAGAnswer(headers, body, context) {
        return {
            status: 501,
            body: {
     ...
     */
    handleDocSummarize(headers, body, context) {
     ...
     */
    handleDocCompare(headers, body, context) {
        const validationResult = this.validateAPIMHeaders(headers);
        if (!validationResult.valid) {
            return {
                status: 400,
     ...
     */
    handleDocExtract(headers, body, context) {
        const validationResult = this.validateAPIMHeaders(headers);
        if (!validationResult.valid) {
            return {
                status: 400,
